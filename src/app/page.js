  ...
  return (
    <main className="relative w-screen h-screen overflow-hidden bg-brand-bg select-none">
      ...
      >
        ...
        {/* Center Bottom Help Caption */}
        {!selectedNode && (
          <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center pointer-events-auto">
            <div className="px-4 py-2 border border-white/5 bg-card-bg/65 backdrop-blur-sm rounded font-mono text-[9px] tracking-[0.2em] text-white/80 uppercase">
              EXPLORE ARYANVERSE // CLICK A STRUCTURE TO ENGAGE DATA VAULT
            </div>
          </div>
        )}
            ...
            <>
              ...
              <div className="flex flex-col gap-3">
                <button
                  ...
                  onClick={() => alert(`Connecting to ${selectedNode.label} interface...`)}
                >
